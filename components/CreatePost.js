   ...
   const FACEBOOK_CLONE_ENDPOINT="http://localhost:8080/api/v1/post";
    ...
    <div className='bg-white rounded-md shadow-md text-gray-500 p-2'>
        ...
        <div className='flex justify-evenly py-2'>
          <div className='flex items-center p-1 space-x-1 flex-grow justify-center hover:bg-gray-100 cursor-pointer'>
            <HiOutlineVideoCamera size={20} className=' text-red-500' />
            <p className=' font-semibold text-gray-600'>Live Video</p>
          </div>
          <div onClick={handleClick} 
          className='flex items-center p-1 space-x-1 flex-grow justify-center hover:bg-gray-100 cursor-pointer'>
